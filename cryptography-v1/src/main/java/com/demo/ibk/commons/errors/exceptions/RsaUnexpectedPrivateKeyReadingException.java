...
import static com.demo.ibk.commons.errors.enums.ExceptionCatalog.RSA_UNEXPECTED_PRIVATE_KEY_READING;

public class RsaUnexpectedPrivateKeyReadingException extends GenericException {

    private static final ExceptionCatalog EXCEPTION = RSA_UNEXPECTED_PRIVATE_KEY_READING;
